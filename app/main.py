...
print(
    f"Least 5 contiguous half-hours: {car_counter.least_n_contiguous_half_hours(df, n=2)}"
)
print(
    f"Least 3 contiguous half-hours: {car_counter.least_n_contiguous_half_hours(df, n=3)}"
)
print(
    f"Least 5 contiguous half-hours: {car_counter.least_n_contiguous_half_hours(df, n=4)}"
)
